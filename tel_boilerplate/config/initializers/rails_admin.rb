# RailsAdmin config file. Generated on July 11, 2013 14:37
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Project Name', 'Admin']
  ...
  # config.excluded_models = ['Authentication', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Authentication', 'Role', 'User']
